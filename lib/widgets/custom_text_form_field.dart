...
extension TextFormFieldStyleHelper on CustomTextFormField {
  ...
  static OutlineInputBorder get fillBlackTL17 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(17.h),
        borderSide: BorderSide.none,
      );
  static OutlineInputBorder get fillBlackTL171 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(17.h),
        borderSide: BorderSide.none,
      );
  static OutlineInputBorder get fillBlackTL172 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(17.h),
        borderSide: BorderSide.none,
      );
}
